defmodule SwapListener.Notifications.Setup do
  @moduledoc false
  use GenServer
  ...
  def init(_) do
    ...
    {:ok, pid} =
      Postgrex.Notifications.start_link(SwapListener.Infra.Repo.config() ++ notifications_opts)
  ...
  defp ensure_trigger_exists do
    ...
    Ecto.Adapters.SQL.query!(SwapListener.Infra.Repo, query)
  end
end
